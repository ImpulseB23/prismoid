// YouTube Live Chat gRPC streaming API.
...
const file_stream_list_proto_rawDesc = "" +
	...
	"\n" +
	"StreamList\x12*.youtube.api.v3.LiveChatMessageListRequest\x1a+.youtube.api.v3.LiveChatMessageListResponse\"\x000\x01B>Z<github.com/ImpulseB23/Prismoid/sidecar/internal/youtube/ytpb"
...
var file_stream_list_proto_depIdxs = []int32{
	...
	22, // 18: youtube.api.v3.LiveChatUserBannedMessageDetails.banned_user_details:type_name -> youtube.api.v3.ChannelProfileDetails
	...
	21, // 20: youtube.api.v3.LiveChatSuperStickerDetails.super_sticker_metadata:type_name -> youtube.api.v3.SuperStickerMetadata
	26, // 21: youtube.api.v3.LiveChatPollDetails.metadata:type_name -> youtube.api.v3.LiveChatPollDetails.PollMetadata
	2,  // 22: youtube.api.v3.LiveChatPollDetails.status:type_name -> youtube.api.v3.LiveChatPollDetails.PollStatusWrapper.PollStatus
	29, // 23: youtube.api.v3.LiveChatGiftDetails.gift_duration:type_name -> google.protobuf.Duration
